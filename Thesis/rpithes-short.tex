...
\specialhead{ABSTRACT}
    ...
    patterns.
    %TODO(Mar 10): explain why we dont send everything to cloud
    ...
    %TODO(mar 10): 75% savings over vehicles not forming clusters (self_clusters configuration)
    %TODO(mar 10): have reference run with no map or reduce (reduce nop, self clusters)

\chapter{INTRODUCTION}
%TODO(mar 10): repeat introduction "this is why were are cool" stuff; applications and challenges need to be
% listed
    ...
    integration with Apache Spark, which allows a user to write a Spark Streaming %TODO(mar 10): add citation and parenthetical explanation of what Spark STreamign is 
    program with
    ...
    %TODO(mar 10): see sentence about why "this is great that everyone hwo can use spark can use spindle"
    ...
    %TODO(mar 10): repeat abstract's "our results show" section
    ...
    The major contributions of the work are:
        \begin{itemize}
            ...
            \item Actor-model-based simulator for map/reduce queries on dynamic clusters of connected vehicles %TODO(mar 10): WHY DO WE CARE?
        \end{itemize}
...
\chapter{Background and Related Work}
    ...
    \section{Cloud Data Processing Technologies}
        ...
        %TODO(meeting mar 8): mention that we are summarizing technologies that we are using and some sample of technologies that are related
...
%TODO(mar 10): say that we have vehicles on roads, vehicles form clusters using wireless ad-hoc network, vehicles have cluster heads that talk to the cloud (reference figure 3.1); explain mapping of our software onto vehicles, clusters, cloud
    %KEY TERMS: vanets/v2v, vehicles, clusterheads, cloud
%TODO(mar 10): put function calls in verbatim
...
\chapter{Conclusion}
    %TODO (mar10): change to past tense
    ...
    %TODO(mar 10): add "our results achieved n% improvement..." passage
