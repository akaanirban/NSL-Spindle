...
\chapter{INTRODUCTION}
    ...
    %TODO(meeting mar 8): split below paragrpah into "this is what we build" and "this is what we evaluate"
    %TODO(meeting mar 8): our contribution is the architecture, our experiments demonste that our contributions are worthwhile
    %TODO(meeting mar8): make a bulleted list of contributions
    ur contribution is to demonstrate the bandwidth savings of performing map/reduce at the edge, in
    ...
    %TODO(meeting mar 8): simplify out reducer window to plain english description
    ...
    %TODO(meeting mar 8): check Carlos examples to see if we should have a "roadmap" paragraph, a chapter-level description of what will follow
        %if necessary, put something straightforward
...
\chapter{Background and Related Work}
    ...
    \subsection{VANETs}
        ...
        simulator.%TODO(meeting mar8): you forgot to put the citation
    ...
    \subsection{Vehicle Clusters}
        \paragraph{Clustering Algorithms}
            %TODO(meeting mar8): cite more than c-drive (look in C-drive related work)
            ...
            -efficient manner \cite{cdrive}. %NOTE: this last sentence is good keep it
    ...
    \section{Edge Computing Technologies}
        %TODO(meeting mar8): do introduction to say why were are describing these things; explain how this builds on cloud tech
    %TODO(meeting mar8): put edge computing before cloud technologies 
    \subsection{Edgent}
    ...
    \subsection{Greengrass}
        %TODO(meeting mar8): say what is being advertised, no need to try and figure it out; it's okay to say something along the lines of "this is what they claim...no details provided"
%TODO(meeting mar8): use quotes selectively 
...
\section*{Future Work}
    ...
    %Ideas:
    % - Integration with other systems such as Flink, Storm/Heron, Lambda?
