...
\subsection{Middleware}
    %TODO: note that it will contain a Kafka Cluster
    %TODO: say that it will have Zookeeper and will read serialized queries from Spark libs, deduplicate queries, send
    % resultant derived queries to vehicle and clusterhead layer for processing
    %TODO: middleware then responsible for sending partially-reduced results to kafka topic exclusively for single
    % Spark Streaming job

\subsection{Vehicles and Clusterheads}
    %TODO: describe vehicle software components
    %TODO: describe role of clusterhead
    %TODO: note that protocol and clustering algorithm agnostic
...
\bibitem{forbes:iot}
    https://www.forbes.com/sites/f5/2017/01/25/four-things-to-watch-for-in-your-cloud-blind-spots/\#52ecf647ad8a
\bibitem{cdrive}
